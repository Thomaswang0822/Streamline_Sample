...
echo Command to run: %EXE_PATH% -EnableHack -Identifier FG_TEST -RenderResolution 1 -ParseJitter -HackPaths "%INPUT_ROOT%" -StoreOutput -BatchIndex i -OutputPath "%OUTPUT_ROOT%"
